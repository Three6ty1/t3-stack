        ...
        <main id='ak-wordle-root' className='flex flex-col w-full h-full justify-top items-center align-middle text-center font-sans p-5 pt-10'>
            ...
            <div className='grid w-full justify-center'>
                ...
                */}
                ...
                <div className='col-start-1 row-start-1 flex flex-col relative top-20 overflow-x-scroll overflow-y-clip md:overflow-y-visible md:overflow-x-visible pb-10'>
