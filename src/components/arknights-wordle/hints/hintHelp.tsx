...
export default function HintHelp() {
    return (
        <>
            <button className="indicator-item flex btn tooltip w-1/3 items-center m-2" data-tip='Help and Info' onClick={() => (document.getElementById('help_modal') as HTMLDialogElement).showModal()}>
